...
export default function TechDifficulties() {
    return (
        <div>
            <h1>The one with technical difficulties</h1>
            <h5>For my besties who want to do a proper study on the Red Wedding (iykyk), feel free to go through the following links and descriptions!</h5>

            <h4>Managing menstruation in the workplace: an overlooked issue in low- and middle-income countries</h4>
            <div>
                <div>
                ...
                <div>
                    <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4895811/" target={"_blank"}>Read detailed article</a>
                </div>
            </div>

            <h4>Menstrual Hygiene, Management, and Waste Disposal: Practices and Challenges Faced by Girls/Women of Developing Countries</h4>
            <div>
                <div>
            ...
            <div>
                <a href="https://www.hindawi.com/journals/jeph/2018/1730964/" target={"_blank"}>Read detailed article</a>
            </div>
