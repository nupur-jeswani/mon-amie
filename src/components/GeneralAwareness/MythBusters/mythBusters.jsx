    ...
    return (
        <div>
            ...
            <div>
                Hey girls!
                <br />
                When it comes to your period, you may have more questions than answers. When does it start? How often does it come? Can certain foods affect how you feel? In your search for details, you may have found information you think is factual. But some of it may be a myth, instead.
                <br />
            ...
            <h4>Fact:</h4>
            <div>
                Most individuals get their first period between 11 and 14 years of age. But every body is different. Don’t worry if you get yours when you’re younger or older than that. However, if you don’t have your first period by the time you’re 15 years of age, talk to your doctor.
                <br />
            ...
            <h4>Myth: Women shed impure blood during periods.</h4>
            <h4>Fact:</h4>
            <div>
            ...
            <h4>Myth: You shouldn’t wash your hair during your period.</h4>
            <h4>Fact:</h4>
            <div>
            ...
            <h4>Myth: If you use a tampon, you lose your virginity.</h4>
            <h4>Fact:</h4>
            <div>
            ...
            <h4>Myth: Hot water increases period flow.</h4>
            <h4>Fact:</h4>
            <div>
            ...
            <h4>Myth: Irregular periods are bad for your reproductive health.</h4>
            <h4>Fact:</h4>
            <div>
            ...
            <div>These are some of the myths that we just busted. Don’t worry chicas, there is nothing wrong and unnatural when it comes to menses unless and until it is pointed out by medical professionals.</div>
        </div>
    )
}
