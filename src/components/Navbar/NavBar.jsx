  ...
  return (
    <>
      <Navbar
        bg="light"
        expand="lg"
        className="container-fluid  rounded-bottom shadow-sm"
        sticky="top"
      >
        <NavbarBrand className="ms-3">
          <img className="ms-2" src={logo} alt="monamie logo" width="10%" />
        </NavbarBrand>
          ...
          <Nav className="container-fluid justify-content-end fw-bold me-auto">
            {user ? (
              <>
                ...
                <NavLink href="http://localhost:8501/">All about PCOS</NavLink>
